...
def sales_report(request):
    ...
    return render(request,'deals/sales_report.html',{'filter':so_filter,'salesperson_buyer':salesperson_buyer,'total_margin':total_margin,"month":month,"month_str":month_str})
