...
urlpatterns = [
    ...
    path('ajax/servicedelivery/outward/nextoutward_summary',servicedelivery_views.nextoutward_summary,name="nextoutward_summary"),
    ...
    path('ajax/payments/payable/allcheques',payment_views.allcheques,name="allcheques"),
    path('ajax/payments/payable/chequeledger',payment_views.chequeledger,name="chequeledger"),
    path('ajax/payments/payable/actualledger',payment_views.actualledger,name="actualledger"),
    ...
    path('payments/payable/cheque/uncleared',payment_views.payable_cheque_uncleared,name = 'payable_cheque_uncleared'),
