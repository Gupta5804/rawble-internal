...
urlpatterns = [
    ...
    path('payments/',payment_views.payment,name = 'payment'),
    ...
    path('service_delivery/inward', servicedelivery_views.inward_service_delivery,name='inward_servicedelivery'),
